  ...
  <div class="formbold-form-wrapper">
    ...
    <form action="EmployeeController" method="POST" onsubmit="showAlert();">
      ...
      <div class="formbold-mb-4">
        ...
        <input type="text" name="firstname" id="firstname" class="formbold-form-input" value="<%= request.getParameter("firstname") %>" />
      ...
      <div class="formbold-mb-4">
        ...
        <input type="text" name="lastname" id="lastname" class="formbold-form-input" value="<%= request.getParameter("lastname") %>" />
      ...
      <div class="formbold-mb-4">
        ...
        <input type="text" name="username" id="username" class="formbold-form-input" value="<%= request.getParameter("username") %>" />
        <span id="username-error" class="error-message"></span>
      </div>
      
      <div class="formbold-mb-3">
        <label for="address" class="formbold-form-label"> Password <span class="hestrick">*</span> </label>
        <input type="password" name="password" id="password" class="formbold-form-input" value="<%= request.getParameter("password") %>" />
      ...
      <div class="formbold-mb-4">
        ...
        <input type="text" name="address" id="address" class="formbold-form-input" value="<%= request.getParameter("address") %>" />
        <span id="address-error" class="error-message"></span>
      </div>
      
      <div>
        <label for="address" class="formbold-form-label"> Contact No. <span class="hestrick">*</span> </label>
        <input type="text" name="contactno" id="contactno" class="formbold-form-input" value="<%= request.getParameter("contactno") %>" />
        <span id="contactno-error" class="error-message"></span>
      </div>
      <input type="hidden" name="action" value="Update">
      <input type="hidden" name="oldusername" value="<%= request.getParameter("username") %>">
      <button id="submitBtn" class="formbold-btn disabled">Update</button>
    </form>
  </div>
</div>
